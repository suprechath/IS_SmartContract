...
const Hero = () => {
    return (
        <section className="relative overflow-hidden">
            ...
            <div className="relative mx-auto container px-4 pt-24 pb-18 sm:px-6 lg:px-8">
                <div className='text-center'>
                    <div className="mx-auto mb-6 inline-flex items-center rounded-full px-4 py-2 text-2xl sm:text-5xl font-bold text-emerald-800">
                        ...
                        <Trees className="mr-2 h-15 w-15" />
                    ...
                    <p className="mx-auto mt-6 max-w-6xl text-lg text-emerald-950/90 sm:text-xl lg:text-2xl">
                        Fund verified energy projects and earn returns while building a more sustainable world. <br />
                        Professional platform trusted by investors and project creators.
                    </p>
                    <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row sm:gap-60">
                        ...
                        <button className="bg-emerald-700 hover:bg-emerald-500 text-emerald-50 font-semibold px-6 py-3 rounded-lg text-lg sm:text-xl transition-bounce shadow-md ">
                            <Link href="/howItWorks">Learn How It Works</Link>
                        </button>
                    </div>
